...
export default {
  ...
  computed: {
    ...
    ...mapState(useCommandStore, ["command", "success"]),
  },
  methods: {
    selectedOS({ target }) {
      this.formData = {
    ...
    ...mapActions(useCommandStore, ["getCommandById", "editCommand"]),
    edit(id) {
      this.editCommand(id);
    },
  },
  created() {
    this.getCommandById(this.$route.params.id);
  },
};
</script>
...
<template>
  <div class="add-category p-5">
    <div class="card w-50 m-auto">
      <div class="card-body">
        <h5 class="card-title form-title text-center">Edit Command</h5>
        ...
        <form>
          ...
          <div class="text-center">
            <button type="button" class="btn btn-dark" @click="edit(formData)">
              Edit Command
            </button>
          </div>
        </form>
